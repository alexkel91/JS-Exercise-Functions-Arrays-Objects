...
function getLastCarInfo(exports) {
  return "This is a " + exports[exports.length -1].car_make +  exports[exports.length -1].car_model; 
}
 ...
 * it will return `This is a Lincoln Navigator`.
*/
function getCarInfoById(exports, id) {
  for (i=0; i<exports.length; i++) {
    if (exports[i].id == id) {
      return "This is a " + exports[i].car_make + exports[i].car_model
    }
  }
}
/**
...
*/
function getOlderCars(exports, car_year) {
  let newArray = []
    for (i=0; i < exports.length; i++){
      if (exports[i].car_year <= car_year){
        newArray.push(exports[i]);
      }
    }
    return newArray;
}
 ...
 * in the same order as they appear in the original inventory.
*/
function getGermanCars(exports) {
  let newArray = [];
  for (i=0; i<exports.length; i++) {
    if (exports[i].car_make == 'Audi') {
      newArray.push(exports[i]);
    } else if (exports[i].car_make == 'Mercedes-Benz') {
      newArray.push(exports[i]);
    } else if (exports[i].car_make == 'Volkswagen') {
      newArray.push(exports[i]);
    }  else if (exports[i].car_make == 'BMW') {
      newArray.push(exports[i]);
    } else continue;
  }
  return newArray;
